...
hl.window_rule({ match = { workspace = gamingWorkspace }, idle_inhibit = "focus" })
hl.workspace_rule({ workspace = gamingWorkspace, default_name = "gaming" })
...
-- hl.window_rule({ match = { class = "firefox", fullscreen = true }, fullscreen_state = "-1 0" })
...
hl.window_rule({ match = { fullscreen_state_internal = 2 }, opacity = "1.0 override" })
...
hl.window_rule({ match = { class = "(.*kdeconnect.*)"}, float = true, center = true, size = "1100 600" })
